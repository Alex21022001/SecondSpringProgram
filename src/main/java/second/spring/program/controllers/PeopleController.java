package second.spring.program.controllers;
...
import second.spring.program.util.PersonValidator;
...
public class PeopleController {
    ...
    public String show(@PathVariable("id") int id, Model model) {
        ...
        model.addAttribute("items",itemsService.findByOwner(peopleService.findById(id)));
        return "people/show";
    }
